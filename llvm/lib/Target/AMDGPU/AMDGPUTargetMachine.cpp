...
static StringRef computeDataLayout(const Triple &TT) {
  ...
  // (address space 7), and 128-bit buffer resourcees (address space 8) which
  // are integral (so inttoptr usage can be optpmized) but cannot be
  // non-trivilally accessed by LLVM memory operations.
