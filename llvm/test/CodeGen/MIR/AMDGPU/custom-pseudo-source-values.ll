...
; CHECK: %[[#]]:vgpr_32 = BUFFER_LOAD_DWORD_OFFSET killed %[[#]], %[[#]], 4, 0, 0, implicit $exec :: (dereferenceable load (s32) from %ir.arg3 + 4, align 1, addrspace 8)
...
define amdgpu_cs void @shader(i32 %arg0, i32 %arg1, <8 x i32> inreg %arg2, ptr addrspace(8) inreg %arg3) {
  %bload0 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %arg3, i32 4, i32 0, i32 0)
  %bload1 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %arg3, i32 8, i32 0, i32 0)
  %bload2 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %arg3, i32 12, i32 0, i32 0)
  %bload3 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %arg3, i32 16, i32 0, i32 0)
...
declare i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8), i32, i32, i32 immarg) #1
