...
declare i32 @llvm.amdgcn.raw.buffer.atomic.and.i32(i32, ptr addrspace(8), i32, i32, i32 immarg)
...
bb4:
  %i5 = call i32 @llvm.amdgcn.raw.buffer.atomic.and.i32(i32 0, ptr addrspace(8) zeroinitializer, i32 0, i32 0, i32 0)
