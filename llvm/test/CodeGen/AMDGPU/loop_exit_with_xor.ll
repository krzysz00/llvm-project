...
then:                                             ; preds = %bb
  call void @llvm.amdgcn.raw.buffer.store.f32(float undef, ptr addrspace(8) undef, i32 0, i32 undef, i32 0)
  br label %endif
...
declare void @llvm.amdgcn.raw.buffer.store.f32(float, ptr addrspace(8), i32, i32, i32 immarg) #0
