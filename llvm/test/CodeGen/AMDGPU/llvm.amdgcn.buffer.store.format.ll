;RUN: llc -global-isel=0 < %s -march=amdgcn -mcpu=verde -verify-machineinstrs | FileCheck -check-prefix=VERDE %s
;RUN: llc -global-isel=0 < %s -march=amdgcn -mcpu=tonga -verify-machineinstrs | FileCheck %s
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 0)
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %2, ptr addrspace(8) %0, i32 0, i32 0, i1 1, i1 0)
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %3, ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 1)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 0, i32 42, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 %2, i32 0, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 0, i32 %2, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 %2, i32 %3, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 %3, i32 %2, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %1, ptr addrspace(8) %0, i32 %2, i32 0, i1 0, i1 0)
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 %3, i32 0, i1 0, i1 0)
  call void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float> %data, ptr addrspace(8) %0, i32 %4, i32 0, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.f32(float %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v2f32(<2 x float> %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}

declare void @llvm.amdgcn.buffer.store.format.f32(float, ptr addrspace(8), i32, i32, i1, i1) #0
declare void @llvm.amdgcn.buffer.store.format.v2f32(<2 x float>, ptr addrspace(8), i32, i32, i1, i1) #0
declare void @llvm.amdgcn.buffer.store.format.v4f32(<4 x float>, ptr addrspace(8), i32, i32, i1, i1) #0
