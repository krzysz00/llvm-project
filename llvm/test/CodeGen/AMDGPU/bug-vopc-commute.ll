...
main_body:
  %d1 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) undef, i32 960, i32 0)
  %d2 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) undef, i32 976, i32 0)
...
declare float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8), i32, i32) #0
