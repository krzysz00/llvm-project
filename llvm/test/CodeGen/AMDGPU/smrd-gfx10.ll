...
define amdgpu_ps float @smrd_imm_dlc(ptr addrspace(8) inreg %desc) #0 {
main_body:
  %r = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %desc, i32 0, i32 4)
  ret float %r
}
...
define amdgpu_ps float @smrd_sgpr_dlc(ptr addrspace(8) inreg %desc, i32 inreg %offset) #0 {
main_body:
  %r = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %desc, i32 %offset, i32 4)
  ret float %r
}
...
define amdgpu_ps float @smrd_imm_glc_dlc(ptr addrspace(8) inreg %desc) #0 {
main_body:
  %r = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %desc, i32 0, i32 5)
  ret float %r
}
...
define amdgpu_ps float @smrd_sgpr_glc_dlc(ptr addrspace(8) inreg %desc, i32 inreg %offset) #0 {
main_body:
  %r = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %desc, i32 %offset, i32 5)
  ret float %r
}
