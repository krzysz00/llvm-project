...
entry:
  ...
  call void @llvm.amdgcn.raw.buffer.store.f32(float %xf, ptr addrspace(8) undef, i32 0, i32 0, i32 0)
  ret void
}

attributes #0 = { nounwind "amdgpu-git-ptr-high"="0x1234" }

declare void @llvm.amdgcn.raw.buffer.store.f32(float, ptr addrspace(8), i32, i32, i32 immarg)
