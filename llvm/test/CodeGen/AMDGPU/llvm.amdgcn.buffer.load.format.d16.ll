...
main_body:
  %data = call half @llvm.amdgcn.buffer.load.format.f16(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
  ret half %data
}
...
main_body:
  %data = call <2 x half> @llvm.amdgcn.buffer.load.format.v2f16(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
...
main_body:
  %data = call <3 x half> @llvm.amdgcn.buffer.load.format.v3f16(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
...
main_body:
  %data = call <4 x half> @llvm.amdgcn.buffer.load.format.v4f16(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
  %elt = extractelement <4 x half> %data, i32 3
  ret half %elt
}

declare half @llvm.amdgcn.buffer.load.format.f16(ptr addrspace(8), i32, i32, i1, i1)
declare <2 x half> @llvm.amdgcn.buffer.load.format.v2f16(ptr addrspace(8), i32, i32, i1, i1)
declare <3 x half> @llvm.amdgcn.buffer.load.format.v3f16(ptr addrspace(8), i32, i32, i1, i1)
declare <4 x half> @llvm.amdgcn.buffer.load.format.v4f16(ptr addrspace(8), i32, i32, i1, i1)
