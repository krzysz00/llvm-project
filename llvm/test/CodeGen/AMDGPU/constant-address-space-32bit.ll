...
main_body:
  ...
  %tmp10 = call nsz float @llvm.amdgcn.struct.buffer.load.format.f32(ptr addrspace(8) %tmp9, i32 undef, i32 0, i32 0, i32 0) #1
  ret float %tmp10
}
...
declare float @llvm.amdgcn.struct.buffer.load.format.f32(ptr addrspace(8), i32, i32, i32, i32) #7
