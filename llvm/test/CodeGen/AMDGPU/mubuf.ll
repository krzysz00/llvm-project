...
main_body:
  ...
  %tmp2 = shl i32 %6, 2
  %tmp3 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %tmp1, i32 %tmp2, i32 64, i32 1)
  %tmp4 = add i32 %6, 16
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp3, ptr addrspace(8) %tmp1, i32 %tmp4, i32 %4, i32 68, i32 3)
  ret void
}
...
main_body:
  %tmp1 = load ptr addrspace(8), ptr addrspace(4) %0
  %tmp2 = shl i32 %6, 2
  %tmp3 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) %tmp1, i32 %tmp2, i32 65, i32 1)
  %tmp4 = add i32 %6, 16
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp3, ptr addrspace(8) %tmp1, i32 %tmp4, i32 %4, i32 68, i32 3)
  ret void
}
...
declare void @llvm.amdgcn.raw.tbuffer.store.i32(i32, ptr addrspace(8), i32, i32, i32 immarg, i32 immarg) #2
declare i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8), i32, i32, i32 immarg) #3
