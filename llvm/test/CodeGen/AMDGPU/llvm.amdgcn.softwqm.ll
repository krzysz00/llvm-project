...
main_body:
  ...
  call void @llvm.amdgcn.struct.buffer.store.f32(float %temp, ptr addrspace(8) undef, i32 %idx0, i32 0, i32 0, i32 0)
...
main_body:
  ...
  call void @llvm.amdgcn.struct.buffer.store.f32(float %temp.0, ptr addrspace(8) undef, i32 %idx0, i32 0, i32 0, i32 0)
  %out = fadd float %temp, %temp
  %out.0 = call float @llvm.amdgcn.softwqm.f32(float %out)
  ret float %out.0
}
...
ELSE:
  ...
  call void @llvm.amdgcn.struct.buffer.store.f32(float %data.sample, ptr addrspace(8) undef, i32 %c, i32 0, i32 0, i32 0)
  br label %END
...
declare float @llvm.amdgcn.struct.buffer.load.f32(ptr addrspace(8), i32, i32, i32, i32 immarg) #3
