...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 0)
  %data_glc = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 1, i1 0)
  %data_slc = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 1)
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 42, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %d.0 = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 4152, i1 0, i1 0)
  %d.1 = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 36856, i1 0, i1 0)
  %d.2 = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 36864, i1 0, i1 0)
...
;VI: s_waitcnt
define amdgpu_ps <4 x float> @buffer_load_immoffs_reuse(ptr addrspace(8) inreg) {
main_body:
  %d.0 = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 4160, i1 0, i1 0)
  %d.1 = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 4176, i1 0, i1 0)
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 %1, i32 0, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 %1, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %ofs = add i32 %1, 60
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 0, i32 %ofs, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 %1, i32 %2, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.format.v4f32(ptr addrspace(8) %0, i32 %2, i32 %1, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call float @llvm.amdgcn.buffer.load.format.f32(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
  ret float %data
}
...
main_body:
  %data = call <2 x float> @llvm.amdgcn.buffer.load.format.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
  ret <2 x float> %data
}

declare float @llvm.amdgcn.buffer.load.format.f32(ptr addrspace(8), i32, i32, i1, i1) #0
declare <2 x float> @llvm.amdgcn.buffer.load.format.v2f32(ptr addrspace(8), i32, i32, i1, i1) #0
