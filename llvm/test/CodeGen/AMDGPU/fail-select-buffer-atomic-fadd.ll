...
define amdgpu_cs void @atomic_fadd(ptr addrspace(8) inreg %arg0) {
  %ret = call float @llvm.amdgcn.buffer.atomic.fadd.f32(float 1.0, ptr addrspace(8) %arg0, i32 0, i32 112, i1 false)
  ret void
}

declare float @llvm.amdgcn.buffer.atomic.fadd.f32(float, ptr addrspace(8), i32, i32, i1 immarg) #0
