...
main_body:
  call void @llvm.amdgcn.buffer.store.format.f16(half %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v2f16(<2 x half> %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}

define amdgpu_kernel void @buffer_store_format_d16_xyz(ptr addrspace(8) %rsrc, <3 x half> %data, i32 %index) {
main_body:
  call void @llvm.amdgcn.buffer.store.format.v3f16(<3 x half> %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}
...
main_body:
  call void @llvm.amdgcn.buffer.store.format.v4f16(<4 x half> %data, ptr addrspace(8) %rsrc, i32 %index, i32 0, i1 0, i1 0)
  ret void
}

declare void @llvm.amdgcn.buffer.store.format.f16(half, ptr addrspace(8), i32, i32, i1, i1)
declare void @llvm.amdgcn.buffer.store.format.v2f16(<2 x half>, ptr addrspace(8), i32, i32, i1, i1)
declare void @llvm.amdgcn.buffer.store.format.v3f16(<3 x half>, ptr addrspace(8), i32, i32, i1, i1)
declare void @llvm.amdgcn.buffer.store.format.v4f16(<4 x half>, ptr addrspace(8), i32, i32, i1, i1)
