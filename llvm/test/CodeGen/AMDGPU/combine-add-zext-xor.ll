...
bb:                                               ; preds = %.a
  %.i3 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) undef, i32 %.2, i32 64, i32 1)
  %i5 = icmp eq i32 %.i3, 0
  br label %bb9
...
declare i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8), i32, i32, i32 immarg) #0
