...
main_body:
  %tmp = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) undef, i32 20, i32 0)
  %tmp1 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) undef, i32 24, i32 0)
  %tmp2 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) undef, i32 48, i32 0)
  ...
  %tmp3 = call i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8) undef, i32 undef, i32 4864, i32 0)
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp3, ptr addrspace(8) undef, i32 36, i32 %arg, i32 68, i32 3)
  %bc = bitcast <4 x float> %array_vector3 to <4 x i32>
  %tmp4 = extractelement <4 x i32> %bc, i32 undef
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp4, ptr addrspace(8) undef, i32 48, i32 %arg, i32 68, i32 3)
  %bc49 = bitcast <4 x float> %array_vector11 to <4 x i32>
  %tmp5 = extractelement <4 x i32> %bc49, i32 undef
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp5, ptr addrspace(8) undef, i32 72, i32 %arg, i32 68, i32 3)
  ...
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 undef, ptr addrspace(8) undef, i32 28, i32 %arg, i32 68, i32 3)
  %bc52 = bitcast <4 x float> %array_vector23 to <4 x i32>
  %tmp6 = extractelement <4 x i32> %bc52, i32 undef
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %tmp6, ptr addrspace(8) undef, i32 64, i32 %arg, i32 68, i32 3)
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 undef, ptr addrspace(8) undef, i32 20, i32 %arg, i32 68, i32 3)
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 undef, ptr addrspace(8) undef, i32 56, i32 %arg, i32 68, i32 3)
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 undef, ptr addrspace(8) undef, i32 92, i32 %arg, i32 68, i32 3)
  ret void
}

declare float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8), i32, i32 immarg) #1
declare i32 @llvm.amdgcn.raw.buffer.load.i32(ptr addrspace(8), i32, i32, i32 immarg) #2
declare void @llvm.amdgcn.raw.tbuffer.store.i32(i32, ptr addrspace(8), i32, i32, i32 immarg, i32 immarg) #3
