...
declare float @llvm.amdgcn.raw.buffer.load.f32(ptr addrspace(8), i32, i32, i32) #2
...
define amdgpu_kernel void @test_export_pos_before_param_across_load(i32 %idx) #0 {
  ...
  %load = call float @llvm.amdgcn.raw.buffer.load.f32(ptr addrspace(8) undef, i32 %idx, i32 0, i32 0)
