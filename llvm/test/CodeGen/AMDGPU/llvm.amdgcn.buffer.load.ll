...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 0)
  %data_glc = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 1, i1 0)
  %data_slc = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 0, i1 0, i1 1)
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 40, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 8192, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 %1, i32 0, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 %1, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %ofs = add i32 %1, 60
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 %ofs, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 %1, i32 %2, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 %2, i32 %1, i1 0, i1 0)
  ret <4 x float> %data
}
...
main_body:
  %data = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 %idx, i32 %ofs, i1 0, i1 0)
  ret float %data
}
...
main_body:
  %data = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 %idx, i32 %ofs, i1 0, i1 0)
  ret <2 x float> %data
}
...
main_body:
  ...
  %data = call <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8) %0, i32 0, i32 %ofs.1, i1 0, i1 0)
  ret <4 x float> %data
}
...
entry:
  ...
  %val = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 0, i1 0, i1 0)
...
;CHECK: s_waitcnt
define amdgpu_ps void @buffer_load_x1_offen_merged(ptr addrspace(8) inreg %rsrc, i32 %a) {
main_body:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
  %a3 = add i32 %a, 12
  ...
  %a5 = add i32 %a, 28
  %a6 = add i32 %a, 32
  %r1 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a1, i1 0, i1 0)
  %r2 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a2, i1 0, i1 0)
  %r3 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a3, i1 0, i1 0)
  %r4 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a4, i1 0, i1 0)
  %r5 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a5, i1 0, i1 0)
  %r6 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a6, i1 0, i1 0)
...
main_body:
  ...
  %r1 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a1, i1 0, i1 0)
  %r2 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a2, i1 0, i1 0)
  %r3 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a3, i1 1, i1 0)
  %r4 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a4, i1 1, i1 0)
  %r5 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a5, i1 1, i1 1)
  %r6 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a6, i1 1, i1 1)
  call void @llvm.amdgcn.exp.f32(i32 0, i32 15, float %r1, float %r2, float %r3, float %r4, i1 true, i1 true)
  call void @llvm.amdgcn.exp.f32(i32 0, i32 15, float %r5, float %r6, float undef, float undef, i1 true, i1 true)
  ret void
}
...
;CHECK-NEXT: buffer_load_dwordx4 v[{{[0-9]}}:{{[0-9]}}], v0, s[0:3], 0 offen offset:4
;CHECK: s_waitcnt
define amdgpu_ps void @buffer_load_x2_offen_merged(ptr addrspace(8) inreg %rsrc, i32 %a) {
main_body:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 12
  %vr1 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 %a1, i1 0, i1 0)
  %vr2 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 %a2, i1 0, i1 0)
...
;CHECK: s_waitcnt
define amdgpu_ps void @buffer_load_x3_offen_merged(ptr addrspace(8) inreg %rsrc, i32 %a) {
main_body:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 12
  %vr1 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 %a1, i1 0, i1 0)
  %r3 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 %a2, i1 0, i1 0)
  %r1 = extractelement <2 x float> %vr1, i32 0
  %r2 = extractelement <2 x float> %vr1, i32 1
...
main_body:
  %r1 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 4, i1 0, i1 0)
  %r2 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
  %r3 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 12, i1 0, i1 0)
  %r4 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 16, i1 0, i1 0)
  %r5 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 28, i1 0, i1 0)
  %r6 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 32, i1 0, i1 0)
  call void @llvm.amdgcn.exp.f32(i32 0, i32 15, float %r1, float %r2, float %r3, float %r4, i1 true, i1 true)
  call void @llvm.amdgcn.exp.f32(i32 0, i32 15, float %r5, float %r6, float undef, float undef, i1 true, i1 true)
  ret void
}
...
main_body:
  %vr1 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 4, i1 0, i1 0)
  %vr2 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 12, i1 0, i1 0)
  %r1 = extractelement <2 x float> %vr1, i32 0
  %r2 = extractelement <2 x float> %vr1, i32 1
  %r3 = extractelement <2 x float> %vr2, i32 0
  %r4 = extractelement <2 x float> %vr2, i32 1
...
;CHECK: s_waitcnt
define amdgpu_ps void @buffer_load_x3_offset_merged(ptr addrspace(8) inreg %rsrc) {
main_body:
  %vr1 = call <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8) %rsrc, i32 0, i32 4, i1 0, i1 0)
  %r3 = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 0, i32 12, i1 0, i1 0)
  %r1 = extractelement <2 x float> %vr1, i32 0
...
define amdgpu_ps float @buffer_load_ubyte(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
...
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_ushort(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 0, i32 16, i1 0, i1 0)
...
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sbyte(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
...
;CHECK-NEXT: v_cvt_f32_i32_e32 v0, v0
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sshort(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 0, i32 16, i1 0, i1 0)
...
;CHECK-NEXT: s_waitcnt vmcnt(0)
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_ubyte_bitcast(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
...
;CHECK-NEXT: s_waitcnt vmcnt(0)
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_ushort_bitcast(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
  %tmp2 = zext i16 %tmp to i32
  %val = bitcast i32 %tmp2 to float
  ret float %val
}
...
;CHECK-NEXT: s_waitcnt vmcnt(0)
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sbyte_bitcast(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
  %tmp2 = sext i8 %tmp to i32
  %val = bitcast i32 %tmp2 to float
...
;CHECK-NEXT: s_waitcnt vmcnt(0)
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sshort_bitcast(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
  %tmp2 = sext i16 %tmp to i32
  %val = bitcast i32 %tmp2 to float
...
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_ubyte_mul_bitcast(ptr addrspace(8) inreg %rsrc, i32 %idx) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 %idx, i32 8, i1 0, i1 0)
  %tmp2 = zext i8 %tmp to i32
...
;CHECK-NEXT: v_mul_u32_u24_e32 v{{[0-9]}}, 0xff, v{{[0-9]}}
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_ushort_mul_bitcast(ptr addrspace(8) inreg %rsrc, i32 %idx) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 %idx, i32 8, i1 0, i1 0)
  %tmp2 = zext i16 %tmp to i32
  %tmp3 = mul i32 %tmp2, 255
  %val = bitcast i32 %tmp3 to float
  ret float %val
...
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sbyte_mul_bitcast(ptr addrspace(8) inreg %rsrc, i32 %idx) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 %idx, i32 8, i1 0, i1 0)
  %tmp2 = sext i8 %tmp to i32
  %tmp3 = mul i32 %tmp2, 255
...
;CHECK-NEXT: v_mul_i32_i24_e32 v{{[0-9]}}, 0xff, v{{[0-9]}}
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sshort_mul_bitcast(ptr addrspace(8) inreg %rsrc, i32 %idx) {
main_body:
  %tmp = call i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8) %rsrc, i32 %idx, i32 8, i1 0, i1 0)
  %tmp2 = sext i16 %tmp to i32
  %tmp3 = mul i32 %tmp2, 255
...
;CHECK-NEXT: ; return to shader part epilog
define amdgpu_ps float @buffer_load_sbyte_type_check(ptr addrspace(8) inreg %rsrc) {
main_body:
  %tmp = call i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8) %rsrc, i32 0, i32 8, i1 0, i1 0)
  %tmp2 = zext i8 %tmp to i32
...
define amdgpu_ps float @no_fold_fi_imm_soffset(ptr addrspace(8) inreg %rsrc) {
  %alloca = alloca i32, addrspace(5)
  %alloca.cast = ptrtoint ptr addrspace(5) %alloca to i32

  %ret.val = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 %alloca.cast, i32 0, i1 false, i1 false)
  ret float %ret.val
}
...
define amdgpu_ps float @no_fold_fi_reg_soffset(ptr addrspace(8) inreg %rsrc, i32 inreg %soffset) {
  %alloca = alloca i32, addrspace(5)
  %alloca.cast = ptrtoint ptr addrspace(5) %alloca to i32

  %ret.val = call float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8) %rsrc, i32 %alloca.cast, i32 %soffset, i1 false, i1 false)
  ret float %ret.val
}

declare float @llvm.amdgcn.buffer.load.f32(ptr addrspace(8), i32, i32, i1, i1) #0
declare <2 x float> @llvm.amdgcn.buffer.load.v2f32(ptr addrspace(8), i32, i32, i1, i1) #0
declare <4 x float> @llvm.amdgcn.buffer.load.v4f32(ptr addrspace(8), i32, i32, i1, i1) #0
declare i8 @llvm.amdgcn.buffer.load.i8(ptr addrspace(8), i32, i32, i1, i1) #0
declare i16 @llvm.amdgcn.buffer.load.i16(ptr addrspace(8), i32, i32, i1, i1) #0
