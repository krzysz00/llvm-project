...
.then:
  ...
  call void @llvm.amdgcn.raw.buffer.store.i32(i32 -1, ptr addrspace(8) %output, i32 %i564, i32 0, i32 0)
  br label %.end

.end:
  %idx = phi i32 [ 0, %.then ], [ %src, %.merge ]
  call void @llvm.amdgcn.raw.buffer.store.i32(i32 -1, ptr addrspace(8) %output, i32 %idx, i32 0, i32 0)
  ret void
}
...
.then:
  call void @llvm.amdgcn.raw.buffer.store.i32(i32 -1, ptr addrspace(8) %output, i32 %src, i32 0, i32 0)
  br label %.end
...
declare void @llvm.amdgcn.raw.buffer.store.i32(i32, ptr addrspace(8), i32, i32 immarg, i32 immarg) #2
