...
; SI-NEXT:    s_movk_i32 s2, 0x1f8
; SI-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x0
; SI-NEXT:    s_movk_i32 s2, 0x1f0
...
; FLAT-NEXT:    s_movk_i32 s2, 0x1f8
; FLAT-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x0
; FLAT-NEXT:    s_movk_i32 s2, 0x1f0
...
if2:
  %.5 = getelementptr inbounds ptr addrspace(8), ptr addrspace(6) null, i32 31, !amdgpu.uniform !0
  %.6 = load ptr addrspace(8), ptr addrspace(6) %.5, align 16, !invariant.load !0
  %.7 = call i32 @llvm.amdgcn.raw.buffer.atomic.swap.i32(i32 %.test1, ptr addrspace(8) %.6, i32 4, i32 0, i32 0)
...
declare i32 @llvm.amdgcn.raw.buffer.atomic.swap.i32(i32, ptr addrspace(8), i32, i32, i32 immarg) #2
