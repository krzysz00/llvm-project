...
main_body:
  ...
  %tmp22 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 96, i32 0)
  %tmp23 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 100, i32 0)
  %tmp24 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 104, i32 0)
  %tmp25 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 112, i32 0)
  %tmp26 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 116, i32 0)
  %tmp27 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 120, i32 0)
  %tmp28 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 128, i32 0)
  %tmp29 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 132, i32 0)
  %tmp30 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 140, i32 0)
  %tmp31 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 144, i32 0)
  %tmp32 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 160, i32 0)
  %tmp33 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 176, i32 0)
  %tmp34 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 180, i32 0)
  %tmp35 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 184, i32 0)
  %tmp36 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 192, i32 0)
  %tmp37 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 196, i32 0)
  %tmp38 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 200, i32 0)
  %tmp39 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 208, i32 0)
  %tmp40 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 212, i32 0)
  %tmp41 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 216, i32 0)
  %tmp42 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 224, i32 0)
  %tmp43 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 240, i32 0)
  %tmp44 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 244, i32 0)
  %tmp45 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 248, i32 0)
  %tmp46 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 256, i32 0)
  %tmp47 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 272, i32 0)
  %tmp48 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 276, i32 0)
  %tmp49 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 280, i32 0)
  %tmp50 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 288, i32 0)
  %tmp51 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 292, i32 0)
  %tmp52 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 296, i32 0)
  %tmp53 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 304, i32 0)
  %tmp54 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 308, i32 0)
  %tmp55 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 312, i32 0)
  %tmp56 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 368, i32 0)
  %tmp57 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 372, i32 0)
  %tmp58 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 376, i32 0)
  %tmp59 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 384, i32 0)
...
main_body:
  %tmp21 = load ptr addrspace(8), ptr addrspace(4) %arg, !tbaa !0
  %tmp22 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 0, i32 0)
  %tmp23 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 4, i32 0)
  %tmp24 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 8, i32 0)
  %tmp25 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 12, i32 0)
  %tmp26 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 28, i32 0)
  %tmp27 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 48, i32 0)
  %tmp28 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 52, i32 0)
  %tmp29 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 56, i32 0)
  %tmp30 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 64, i32 0)
  %tmp31 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 68, i32 0)
  %tmp32 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 72, i32 0)
  %tmp33 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 76, i32 0)
  %tmp34 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 128, i32 0)
  %tmp35 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 132, i32 0)
  %tmp36 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 144, i32 0)
  %tmp37 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 148, i32 0)
  %tmp38 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 152, i32 0)
  %tmp39 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 160, i32 0)
  %tmp40 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 164, i32 0)
  %tmp41 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 168, i32 0)
  %tmp42 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 172, i32 0)
  %tmp43 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 176, i32 0)
  %tmp44 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 180, i32 0)
  %tmp45 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 184, i32 0)
  %tmp46 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 192, i32 0)
  %tmp47 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 196, i32 0)
  %tmp48 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 200, i32 0)
  %tmp49 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 208, i32 0)
  %tmp50 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 212, i32 0)
  %tmp51 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 216, i32 0)
  %tmp52 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 220, i32 0)
  %tmp53 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 236, i32 0)
  %tmp54 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 240, i32 0)
  %tmp55 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 244, i32 0)
  %tmp56 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 248, i32 0)
  %tmp57 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 252, i32 0)
  %tmp58 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 256, i32 0)
  %tmp59 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 260, i32 0)
  %tmp60 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 264, i32 0)
  %tmp61 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 268, i32 0)
  %tmp62 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 272, i32 0)
  %tmp63 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 276, i32 0)
  %tmp64 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 280, i32 0)
  %tmp65 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 284, i32 0)
  %tmp66 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 288, i32 0)
  %tmp67 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 292, i32 0)
  %tmp68 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 464, i32 0)
  %tmp69 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 468, i32 0)
  %tmp70 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 472, i32 0)
  %tmp71 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 496, i32 0)
  %tmp72 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 500, i32 0)
  %tmp73 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 504, i32 0)
  %tmp74 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 512, i32 0)
  %tmp75 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 516, i32 0)
  %tmp76 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 524, i32 0)
  %tmp77 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 532, i32 0)
  %tmp78 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 536, i32 0)
  %tmp79 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 540, i32 0)
  %tmp80 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 544, i32 0)
  %tmp81 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 548, i32 0)
  %tmp82 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 552, i32 0)
  %tmp83 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 556, i32 0)
  %tmp84 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 560, i32 0)
  %tmp85 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 564, i32 0)
  %tmp86 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 568, i32 0)
  %tmp87 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 572, i32 0)
  %tmp88 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 576, i32 0)
  %tmp89 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 580, i32 0)
  %tmp90 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 584, i32 0)
  %tmp91 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 588, i32 0)
  %tmp92 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 592, i32 0)
  %tmp93 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 596, i32 0)
  %tmp94 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 600, i32 0)
  %tmp95 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 604, i32 0)
  %tmp96 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 608, i32 0)
  %tmp97 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 612, i32 0)
  %tmp98 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 616, i32 0)
  %tmp99 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 624, i32 0)
  %tmp100 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 628, i32 0)
  %tmp101 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 632, i32 0)
  %tmp102 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 636, i32 0)
  %tmp103 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 640, i32 0)
  %tmp104 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 644, i32 0)
  %tmp105 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 648, i32 0)
  %tmp106 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 652, i32 0)
  %tmp107 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 656, i32 0)
  %tmp108 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 660, i32 0)
  %tmp109 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 664, i32 0)
  %tmp110 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 668, i32 0)
  %tmp111 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 672, i32 0)
  %tmp112 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 676, i32 0)
  %tmp113 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 680, i32 0)
  %tmp114 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 684, i32 0)
  %tmp115 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 688, i32 0)
  %tmp116 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 692, i32 0)
  %tmp117 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 696, i32 0)
  %tmp118 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 700, i32 0)
  %tmp119 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 704, i32 0)
  %tmp120 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 708, i32 0)
  %tmp121 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 712, i32 0)
  %tmp122 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 716, i32 0)
  %tmp123 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 864, i32 0)
  %tmp124 = call float @llvm.amdgcn.s.buffer.load.f32(ptr addrspace(8) %tmp21, i32 868, i32 0)
