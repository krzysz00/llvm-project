...
bb49:
  call void @llvm.amdgcn.raw.tbuffer.store.f32(float 1.0, ptr addrspace(8) %buffer, i32 4, i32 1, i32 116, i32 1)
  ret void
...
declare void @llvm.amdgcn.raw.tbuffer.store.f32(float, ptr addrspace(8), i32, i32, i32 immarg, i32 immarg) #2
