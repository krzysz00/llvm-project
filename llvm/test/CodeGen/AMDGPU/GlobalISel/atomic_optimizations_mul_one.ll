...
declare i32 @llvm.amdgcn.struct.buffer.atomic.add.i32(i32, ptr addrspace(8), i32, i32, i32, i32 immarg)
declare i32 @llvm.amdgcn.struct.buffer.atomic.sub.i32(i32, ptr addrspace(8), i32, i32, i32, i32 immarg)
declare i32 @llvm.amdgcn.struct.buffer.atomic.xor.i32(i32, ptr addrspace(8), i32, i32, i32, i32 immarg)
declare void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32>, ptr addrspace(8), i32, i32, i32, i32 immarg)

define amdgpu_cs void @atomic_add(ptr addrspace(8) inreg %arg)  {
; IR-LABEL: @atomic_add(
; IR-NEXT:  .entry:
...
; IR:       9:
; IR-NEXT:    [[TMP10:%.*]] = call i32 @llvm.amdgcn.struct.buffer.atomic.add.i32(i32 [[TMP7]], ptr addrspace(8) [[ARG:%.*]], i32 0, i32 0, i32 0, i32 0)
...
; GCN-NEXT:    s_endpgm
.entry:
  call i32 @llvm.amdgcn.struct.buffer.atomic.add.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  ret void
}
...
; IR-NEXT:    [[B:%.*]] = ptrtoint ptr addrspace(8) [[ARG]] to i128
; IR-NEXT:    [[C:%.*]] = bitcast i128 [[B]] to <4 x i32>
; IR-NEXT:    call void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32> [[C]], ptr addrspace(8) [[ARG]], i32 [[TMP14]], i32 0, i32 0, i32 0)
; IR-NEXT:    ret void
;
...
; GCN-NEXT:    s_endpgm
.entry:
  %a = call i32 @llvm.amdgcn.struct.buffer.atomic.add.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  %b = ptrtoint ptr addrspace(8) %arg to i128
  %c = bitcast i128 %b to <4 x i32>
  call void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32> %c, ptr addrspace(8) %arg, i32 %a, i32 0, i32 0, i32 0)
  ret void
}
...
; IR-NEXT:    br i1 [[TMP8]], label [[TMP9:%.*]], label [[TMP11:%.*]]
; IR:       9:
; IR-NEXT:    [[TMP10:%.*]] = call i32 @llvm.amdgcn.struct.buffer.atomic.sub.i32(i32 [[TMP7]], ptr addrspace(8) [[ARG:%.*]], i32 0, i32 0, i32 0, i32 0)
; IR-NEXT:    br label [[TMP11]]
; IR:       11:
; IR-NEXT:    ret void
;
...
; GCN-NEXT:    s_endpgm
.entry:
  call i32 @llvm.amdgcn.struct.buffer.atomic.sub.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  ret void
}
...
; GCN-NEXT:    s_endpgm
.entry:
  %a = call i32 @llvm.amdgcn.struct.buffer.atomic.sub.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  %b = ptrtoint ptr addrspace(8) %arg to i128
  %c = bitcast i128 %b to <4 x i32>
  call void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32> %c, ptr addrspace(8) %arg, i32 %a, i32 0, i32 0, i32 0)
  ret void
...
; IR:       10:
; IR-NEXT:    [[TMP11:%.*]] = call i32 @llvm.amdgcn.struct.buffer.atomic.xor.i32(i32 [[TMP8]], ptr addrspace(8) [[ARG:%.*]], i32 0, i32 0, i32 0, i32 0)
...
; GCN-NEXT:    s_endpgm
.entry:
  call i32 @llvm.amdgcn.struct.buffer.atomic.xor.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  ret void
}
...
; IR-NEXT:    [[B:%.*]] = ptrtoint ptr addrspace(8) [[ARG]] to i128
; IR-NEXT:    [[C:%.*]] = bitcast i128 [[B]] to <4 x i32>
; IR-NEXT:    call void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32> [[C]], ptr addrspace(8) [[ARG]], i32 [[TMP16]], i32 0, i32 0, i32 0)
; IR-NEXT:    ret void
;
...
; GCN-NEXT:    s_endpgm
.entry:
  %a = call i32 @llvm.amdgcn.struct.buffer.atomic.xor.i32(i32 1, ptr addrspace(8) %arg, i32 0, i32 0, i32 0, i32 0)
  %b = ptrtoint ptr addrspace(8) %arg to i128
  %c = bitcast i128 %b to <4 x i32>
  call void @llvm.amdgcn.struct.buffer.store.format.v4i32(<4 x i32> %c, ptr addrspace(8) %arg, i32 %a, i32 0, i32 0, i32 0)
  ret void
