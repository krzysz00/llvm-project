...
define amdgpu_vs void @test1(i32 %v) #0 {
  ...
  call void @llvm.amdgcn.raw.tbuffer.store.i32(i32 %v, ptr addrspace(8) undef, i32 0, i32 0, i32 68, i32 1)
...
declare void @llvm.amdgcn.raw.tbuffer.store.i32(i32, ptr addrspace(8), i32, i32, i32 immarg, i32 immarg) #1
