...
define amdgpu_ps void @buffer_atomic_add_f32(ptr addrspace(8) inreg %rsrc, float %data, i32 %vindex) {
main_body:
...
define amdgpu_ps void @buffer_atomic_add_f32_off4_slc(ptr addrspace(8) inreg %rsrc, float %data, i32 %vindex) {
main_body:
...
define amdgpu_ps void @buffer_atomic_pk_add_v2f16(ptr addrspace(8) inreg %rsrc, <2 x half> %data, i32 %vindex) {
main_body:
...
define amdgpu_ps void @buffer_atomic_pk_add_v2f16_off4_slc(ptr addrspace(8) inreg %rsrc, <2 x half> %data, i32 %vindex) {
main_body:
