...
main_body:
  ...
  call void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32> %buf1.vec, ptr addrspace(8) %buf2, i32 0, i32 0, i32 0)
...
main_body:
  ...
  call void @llvm.amdgcn.raw.buffer.store.i32(i32 %offset, ptr addrspace(8) %buffer, i32 %offset, i32 0, i32 0)
...
declare void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32>, ptr addrspace(8), i32, i32, i32 immarg)
