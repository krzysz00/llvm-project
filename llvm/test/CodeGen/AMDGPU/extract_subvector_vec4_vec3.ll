...
define amdgpu_hs void @main(ptr addrspace(6) inreg %arg) {
  ...
  ; GCN-NEXT:   S_ENDPGM 0
main_body:
  %tmp25 = call <4 x float> @llvm.amdgcn.raw.buffer.load.v4f32(ptr addrspace(8) undef, i32 undef, i32 0, i32 0)
  ...
  call void @llvm.amdgcn.raw.buffer.store.v3i32(<3 x i32> %tmp29, ptr addrspace(8) undef, i32 undef, i32 0, i32 0) #3
  ret void
}

declare void @llvm.amdgcn.raw.buffer.store.v3i32(<3 x i32>, ptr addrspace(8), i32, i32, i32 immarg)
